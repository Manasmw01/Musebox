...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvhdl -v93 "$QSYS_SIMDIR/fir_equalizer_rtl.vhd"                          
  ncvhdl -v93 "$QSYS_SIMDIR/fir_equalizer_ast.vhd"                          
  ncvhdl -v93 "$QSYS_SIMDIR/fir_equalizer.vhd"                              
  ncvhdl -v93 "$QSYS_SIMDIR/fir_equalizer_tb.vhd"                           
fi
