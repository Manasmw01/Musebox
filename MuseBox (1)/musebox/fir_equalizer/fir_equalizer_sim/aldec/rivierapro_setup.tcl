...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "fir_equalizer"
}
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/fir_equalizer_rtl_rm.hex ./
  file copy -force $QSYS_SIMDIR/fir_equalizer_rtl_u0_m0_wo0_cm0.hex ./
}
...
alias com {
  ...
  vcom "$QSYS_SIMDIR/fir_equalizer_rtl.vhd"                          
  vcom "$QSYS_SIMDIR/fir_equalizer_ast.vhd"                          
  vcom "$QSYS_SIMDIR/fir_equalizer.vhd"                              
  vcom "$QSYS_SIMDIR/fir_equalizer_tb.vhd"                           
}
