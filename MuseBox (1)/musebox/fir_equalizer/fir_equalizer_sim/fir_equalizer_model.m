...
bankcount = 1;
pfc_exists = true;
  coef_in_file = fopen ('fir_equalizer_coef_reload.txt', 'r');
...
for j = 1:sx
    ...
    %
    file_name = ['fir_equalizer_input.txt'];
    ...
    for i = 1: num_ch
     ...
     % run this output through the model 
      if(bankcount>1)
        output = fir_equalizer_mlab(data_channel, bank_channel, h);
      else
        output = fir_equalizer_mlab(data_channel, h);
      end
    ...
    file_name = ['fir_equalizer_model_output'];
