...
# ACDS 13.1.1 166 linux 2014.05.11.23:23:03
...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/fir_equalizer_rtl_rm.hex ./
  cp -f $QSYS_SIMDIR/fir_equalizer_rtl_u0_m0_wo0_cm0.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm "$QSYS_SIMDIR/fir_equalizer_rtl.vhd"                          
  vhdlan -xlrm "$QSYS_SIMDIR/fir_equalizer_ast.vhd"                          
  vhdlan -xlrm "$QSYS_SIMDIR/fir_equalizer.vhd"                              
  vhdlan -xlrm "$QSYS_SIMDIR/fir_equalizer_tb.vhd"                           
fi
