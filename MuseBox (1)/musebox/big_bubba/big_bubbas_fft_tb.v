...
initial
   begin
     ...
     fftpts_array[1]=16384;
     fftpts_array[2]=16384;
     fftpts_array[3]=16384;
     data_rf = $fopen("big_bubbas_fft_real_input.txt","r");
     data_if = $fopen("big_bubbas_fft_imag_input.txt","r");
     fft_rf = $fopen("big_bubbas_fft_real_output_ver.txt");
     fft_if =$fopen("big_bubbas_fft_imag_output_ver.txt");
     expf = $fopen("big_bubbas_fft_exponent_output_ver.txt");
     #0 clk = 1'b0;
     #0 reset_n = 1'b0;
     #92 reset_n = 1'b1;
  end
